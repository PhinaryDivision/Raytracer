...
dialectric::dialectric(double refraction_index) : refraction_index(refraction_index) {}

bool dialectric::scatter(const ray& r_in, const hit_record& rec, color& attenuation, ray& scattered) const {
